            ...
            <div>
                ...
                <div className='grid grid-cols-4 gap-3 mx-5 mb-20'>
                    ...
                    <div className=" relative text-md group">
                        <span className="bg-white absolute right-0 top-0 px-2 rounded-s-lg flex gap-2 group"><BsHeart className="text-black my-auto group-hover:animate-bounce" /> 98</span>
                        <div className='bg-gray-100 h-96 border p-3 flex items-center'>
