...
function ShippingNote() {
    return (
        <>
            <div className='flex  text-white bg-sky-600 text-2xl'>

                {/* <div className=' bg-opacity-60 px-12 py-2 border-r-2 border-black'> */}
                    {/* <p className="text-xl font-bold ">Customer Service <span>^</span></p>
                     */}

                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white text-2xl  hover:text-blue-200 focus:ring-4 focus:outline-none  font-medium rounded-lg px-4 py-2.5 text-center inline-flex items-center " type="button">Customer Service <svg className="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
                    {/* <!-- Dropdown menu --> */}
                ...
                {/* </div> */}
                <div className='px-10 py-2 ml-auto mr-4'>
                    <p>Every Zappos order comes FAST, FREE Shipping, plus a FREE 365-Day Return Policy! <b>More About Shipping & Returns</b></p>
                </div>
            </div>
        </>
    )
